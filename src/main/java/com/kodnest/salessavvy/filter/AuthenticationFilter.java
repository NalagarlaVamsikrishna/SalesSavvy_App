...
public class AuthenticationFilter implements Filter {
	...
	private AuthenticationFilter(AuthService authService, UserRepository userRepo) {
	...
	private void executeFilterLogic(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		...
		// Get authentinticated user and role
		User authenticatedUser = userOptional.get();
		Role role = authenticatedUser.getRole();
		logger.info("Authrnticated User: {}, Role: {}",authenticatedUser.getUsername(), role);
		...
		// Attach user detaails to request
	...
	private void setCORSHeaders(HttpServletResponse response) {
		...
		response.setHeader("Access-Control-Allow-Methods", "GET, POST,PUT, DLETE, OPTIONS");
